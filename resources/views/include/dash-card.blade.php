<div class="w-full h-full p-10 flex justify-between flex-wrap">
    <!-- Start First Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-1">
            ...
            <div class="mt-3">
                <form action="{{ route('dashboard.journal') }}" method="get">
    ...
    <!-- End First Card -->
    <!-- Start Second Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-2">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- End Second Card -->
    <!-- Start Third Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-3">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- Start Fourth Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-4">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- End Fourth Card -->
    <!-- Start Fifth Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-5">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- End Fifth Card -->
    <!-- Start Sixth Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-6">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- Start Seventh Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-7">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- Start Eigth Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-8">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
    ...
    <!-- Start Nineth Card -->   
        <div class="flex flex-col w-full mb-7 xl:mb-0 xl:w-[31%] h-72 rounded-xl card-9">
            <div class="flex items-end mr-3 justify-end">
                <button
                    id="dropdown-button"
                    class="relative mt-3 bg-gray-400 text-black w-8 h-8 rounded-full">
